...
if "%1" eq "" .or. "%1" eq "alt" .or. "%1" eq "normal" (goto :%MachineName%)
    ...
    :Default
    :Demona20231218
        call important_less "Fixing WinAmp window positions [20231218]"
    goto :END

	:Demona
	:Demona20231101
        call important_less "Fixing WinAmp window positions"
        ...
        activate "minilyrics"      pos=,,1120,1010
        activate "Floating Lyrics" pos=1075,-1070,2430,225
...
rem     activate "album art"       pos=01030,-0800,0410,410 %+ REM but then later it was right!
    ...
    :20230714
        %COLOR_IMPORTANT_LESS% %+ echo %emoji_hammer% Fixing WinAmp window positions...%emoji_hammer%
        REM activate "minilyrics" POS=2025,10,590,590              
        REM activate "minilyrics" POS=-907,-1085,700,670
        REM winamp 5.9.2:
