...
%COLOR_NORMAL%  %+ cd      "%1"
%COLOR_NORMAL%  %+ call    "%2"
:COLOR_DEBUG%   %+ echo if not exist "%@UNQUOTE[c:\recycler\%@NAME[%2]]" (move /r "%@UNQUOTE[%2]" c:\recycler)
%COLOR_REMOVAL% %+      if not exist "%@UNQUOTE[c:\recycler\%@NAME[%2]]" (move /r "%@UNQUOTE[%2]" c:\recycler)
%COLOR_NORMAL% 
