...
::::: PROCESS COMMAND-LINE ARGUMENTS FOR DIFFERENT INVOCATIONS:
...
::::: PERFORM THE RESTART:
    %COLOR_REMOVAL% 
                echo Killing %RESTART_NAME_COLLOQIAL%...
                call killIfRunning %RESTART_NAME_PROCESS% %RESTART_NAME_PROCESS%

    %COLOR_IMPORTANT_LESS% 
                echo Waiting %RESTART_WAIT_TIME_AFTER_KILL% seconds...
                call  sleep  %RESTART_WAIT_TIME_AFTER_KILL%

    %COLOR_SUCCCESS% 
                echo Restarting %RESTART_NAME_COLLOQIAL%...

    %COLOR_RUN% 
                %RESTART_START_COMMAND%

    %COLOR_IMPORTANT_LESS% 
                echo Waiting %RESTART_WAIT_TIME_AFTER_RESTART% seconds...
                call  sleep  %RESTART_WAIT_TIME_AFTER_RESTART%




::::: ACTIVATE/BRING NEW WINDOW TO FRONT:
    :   echo Experiment: option to do "window restore [windowname]"  - may need a %RESTART_WINDOW_RESTORE_WINDOW_NAME%R option
    :   :example: window restore evilly~1
...
goto :END
            ...
            :Usage
                %COLOR_ADVICE%
                    ...
                    echo                                  May need to use %%@SFN[something] to get a spaceless filename.
                    echo.
                goto :END
            ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
:END
    :Cleanup_START
        ...
        ::::: CLEAR VARIABLES SO NO LEAKING TO SUCCESSIVE RUNS:
