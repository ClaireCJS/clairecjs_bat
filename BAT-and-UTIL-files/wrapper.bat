...
::::: Change arguments into short filenames:
    ...
    :: should use a loop and SHIFT but pasting this  was faster...




::::: Make correct window title, special case if its our text editor:
    iff "%1"=="%EDITOR" then
        GoSub TitleAlt
...
::::: Run the new modified command line
    %COLOR_UNIMPORTANT% 
    call debug "* cmdline is %*"
    %COLOR_NORMAL%      
