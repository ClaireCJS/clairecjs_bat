...
setdos /x-678
    ...
    %COLOR_TO_USE% %+ echos %BIG_TEXT_LINE_1%%PARAMS%%BIG_TEXT_END%%ANSI_COLOR_NORMAL%%ANSI_ERASE_TO_EOL% %+ echo.
    %COLOR_TO_USE% %+ echos %BIG_TEXT_LINE_2%%PARAMS%%BIG_TEXT_END%%ANSI_COLOR_NORMAL%%ANSI_ERASE_TO_EOL% %+ if %ECHOSBIG ne 1 (echo.)
