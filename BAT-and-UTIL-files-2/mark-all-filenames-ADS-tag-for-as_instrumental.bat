...
rem Validate environment (once):
        iff "1" != "validated_markallfilenamesadstagsasinstrumental" then
                call validate-in-path preview-audio-file advice get-lyrics-for-file.btm
                set  validated_markallfilenamesadstagsasinstrumental=1
        endiff
...
rem Call sub-part of lyric-AI-transcription system where this is coded:
        gosub "%BAT%\get-lyrics-for-file.btm" mark_every_file_as_an_instrumental_ADS_tag_only %*
