...
rem Validate environment (once):
        iff "1" != "validated_markallfilenamesadstagsasNOTinstrumental" then
                call validate-in-path preview-audio-file advice get-lyrics-for-file.btm
                set  validated_markallfilenamesadstagsasNOTinstrumental=1
        endiff
...
rem Call sub-part of lyric-AI-transcription system where this is coded:
        gosub "%BAT%\get-lyrics-for-file.btm" mark_every_file_as_NOT_an_instrumental_ADS_tag_only %*
