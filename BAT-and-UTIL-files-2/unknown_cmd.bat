...
*rem ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ CONFIGURATION: ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
*if not defined unknown_command_highlight_color set unknown_command_highlight_color=%ANSI_BRIGHT_YELLOW%
*if not defined wait_time_for_unknown_commands  set wait_time_for_unknown_commands=9999 %+ I want 43200 for 12 hours, but TCC v33 seemingly has max of 9999 
...
*echoerr 🚩 %ANSI_COLOR_ERROR% Unknown command: '%italics%%unknown_command_highlight_color%%1$%ANSI_COLOR_ERROR%%italics_off%' %@unquote[%@IF["" != "%_PBATCHNAME","%ANSI_BACKGROUND_BLACK% in %italics%%[_PBATCHNAME]%italics_off%",]]%ANSI_RESET% 🚩 
*if defined BATCHLINE *echoerr 🚩 %ANSI_COLOR_ERROR% Line number: %italics%%unknown_command_highlight_color%%BATCHLINE%%ANSI_COLOR_ERROR%%italics_off%
*beep
