...
:cho if isdir   %WHAT_TO_ZIP%  goto :itsadir
...
%COLOR_IMPORTANT_LESS%    %+ echos * TIP: set AUTO_DEL_DIR=1 to automatically deltree the dir after success. 
%COLOR_WARNING            %+ echos   Be careful!!!!!
%COLOR_IMPORTANT%         %+ echo.

%COLOR_PROMPT% %+ echos * DONE! %+ %COLOR_NORMAL% %+ echo. %+ echo. %+ echo. %+ echo.
