...
rem VALIDATE ENVIRONMENT:
        iff 1 ne %VALIDATED_WHISPERTIMESYNCHELPER% then
                ...
                call validate-environment-variables JAVA_WHISPERTIMESYNC WhisperTimeSync our_language color_advice ansi_color_advice
...
rem Did it work?
        ...
        iff exist "%SRT_NEW%" then
                ...
                call validate-environment-variable SRT_NEW "WhisperTimeSync did not produce expected output file of “%SRT_NEW%”"
        endiff
