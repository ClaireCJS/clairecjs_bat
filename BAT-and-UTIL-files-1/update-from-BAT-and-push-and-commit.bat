...
rem display limit so that bat files starting with Z can actually be browsed to:
        ...
        echo.
        (((echo rayr|*copy /u /r /Ns %TARGET_MAIN%\[m-z]* %TARGET_2% ) |:u8 copy-move-post.py) |:u8 fast_cat)
