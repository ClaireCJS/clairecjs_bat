...
rem Ask for each file, and delete:
        *setdos /x-168
        ...
        :do_file [file]
                ...
                rem Generate question to ask user...
                        :reask
                ...
                rem Allow environment flags to modify our behavior to be specific to our AI Lyric system:
                        iff "%DEL_AFTER_REVIEW_MODE%" == "AILyrics" then
                                set direct_object_clause= out hallucinations
                        else
                                set direct_object_clause=
                        endiff
                ...
                rem If file is still there, interpret the answers to our questoin:
                                ...
                                rem Deal with individual answers:
                                        set hold_file=%file%
                                                iff "E" == "%ANSWER%" then
                                                        call less_important "Launching text editor"
                                                        sleep 3
                                                        %EDITOR% "%@UNQUOTE["%file%"]" 
