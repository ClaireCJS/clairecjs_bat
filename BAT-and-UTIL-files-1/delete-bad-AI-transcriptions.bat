...
rem ACTUALLY SEARCH FOR BAD AI TRANSCRIPTIONS!!!
        ...
        goto :skip_old_way
                                                                    rem                                                    gosub step %+ if exist *.lrc                              (grep -li this.is.the.first.sentence                                 *.lrc >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.srt                              (grep -li this.is.the.first.sentence                                 *.srt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.lrc                              (grep -li and.we.are.back                                            *.lrc >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.lrc                              (grep -li Ding,.ding,.bop                                            *.lrc >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.lrc                              (grep -li a.little.pause\.\.\.                                       *.lrc >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.lrc                              (grep -li I.m.going.to.play.a.little.bit.of.the.first.one.*and.then  *.lrc >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.srt                              (grep -li and.we.are.back                                            *.srt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.srt                              (grep -li Ding,.ding,.bop                                            *.srt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.txt                              (grep -li and.we.are.back                                            *.txt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.txt                              (grep -li this.is.the.first.sentence                                 *.txt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.txt                              (grep -li Ding,.ding,.bop                                            *.txt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.txt                              (grep -li I.m.going.to.play.a.little.bit.of.the.first.one.*and.then  *.txt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.srt                              (grep -li I.m.going.to.play.a.little.bit.of.the.first.one.*and.then  *.srt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.srt                              (grep -li a.little.pause\.\.\.                                       *.srt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.txt                              (grep -li a.little.pause\.\.\.                                       *.txt >>:u8 %tmpfile1%) %+ rem WhisperAI silence hallucination
                                                                    rem                                                    gosub step %+ if exist *.srt except /Ne ("*lady in red*") (grep -li "I.ve never seen you looking so lovely as you did tonight" *.srt >>:u8 %tmpfile1%) %+ rem Chris DeBurg - Lady In Red
                                                                    rem                                                    gosub step %+ if exist *.lrc except /Ne ("*lady in red*") (grep -li "I.ve never seen you looking so lovely as you did tonight" *.lrc >>:u8 %tmpfile1%) %+ rem Chris DeBurg - Lady In Red
                                                                    rem                                                    gosub step %+ if exist *.txt except /Ne ("*lady in red*") (grep -li "I.ve never seen you looking so lovely as you did tonight" *.txt >>:u8 %tmpfile1%) %+ rem Chris DeBurg - Lady In Red
                                                                    rem                                                    gosub step %+ if exist *.srt except /Ne ( "*black city*") (grep -li "Closed lamps, curfews, dead leaves"                       *.srt >>:u8 %tmpfile1%) %+ rem Voivod - Black City
                                                                    rem                                                    gosub step %+ if exist *.lrc except /Ne ( "*black city*") (grep -li "Closed lamps, curfews, dead leaves"                       *.lrc >>:u8 %tmpfile1%) %+ rem Voivod - Black City
                                                                    rem                                                    gosub step %+ if exist *.txt except /Ne ( "*black city*") (grep -li "Closed lamps, curfews, dead leaves"                       *.txt >>:u8 %tmpfile1%) %+ rem Voivod - Black City
