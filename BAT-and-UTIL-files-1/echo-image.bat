...
rem RENDERING:
        ...
        elseiff "1" == "%CHAFA_ASCII_ART%" then 
                set LAST_CHAFA_COMMAND=chafa  --format=symbols  --colors= 2    --symbols=ascii     %chafa_rest%
        elseiff "1" == "%CHAFA_ANSI_ART%" then                                              
                set LAST_CHAFA_COMMAND=chafa  --format=symbols  --colors=16/8  --symbols=all       %chafa_rest%
        else                                                                                
                set LAST_CHAFA_COMMAND=chafa  --format=sixels   --colors=full  %chafa_view_size%   %chafa_rest%
        endiff
