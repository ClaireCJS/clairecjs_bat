...
rem ENVIRONMENT VALIDATION:
        iff %EC_VALIDATED ne 1 then
                rem  validate-environment-variables TMPMUSICSERVERCDRIVE MUSICSERVERCDRIVE AUDIOSCROBBLER_LOG MACHINENAME MUSICSERVERMACHINENAME EDITOR TEMP MACHINENAME MUSICSERVERMACHINENAME MUSICSERVERUSERNAME
                call validate-environment-variables TMPMUSICSERVERCDRIVE MUSICSERVERCDRIVE   NOW_PLAYING_TXT  MACHINENAME MUSICSERVERMACHINENAME EDITOR TEMP MACHINENAME MUSICSERVERMACHINENAME MUSICSERVERUSERNAME
