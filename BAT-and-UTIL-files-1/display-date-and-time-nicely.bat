...
call bigecho "%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%%TIM_EMO_TO_USE%"
echo %MSG
