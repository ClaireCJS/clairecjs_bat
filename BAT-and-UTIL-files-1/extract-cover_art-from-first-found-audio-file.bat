...
rem Validate environment:
        ...
        call validate-in-path extract-cover_art-from-first-found-audio-file.bat run-eaa-in-appropriate-subfolders.bat eaa-if-appropriate-for-workflow.bat eaa.bat extract-cover_art-from-first-found-audio-file.bat fix-wrong-image-extensions


rem DETERMINE IF WE'VE BEEN HERE BEFORE:
...
rem DETERMINE IF WE SHOULDN'T BE HERE AT ALL:
...
rem CLEANUP BACKUPS THAT ARE THE SAME AS WHAT THEY ARE BACKING UP, AND ALSO (last 3 lines) DON'T HAVE FOLDER.JPG THAT DUPLICATES COVER.JPG:
