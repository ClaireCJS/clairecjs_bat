...
rem Validate parameters every time
        if not exist "%Lyric_File_To_Disapprove%" call validate-environment-variable Lyric_File_To_Disapprove "First arg must be a lyric file. 2ⁿᵈ optional arg can be a tag other than 'lyrics' to add to file, 3ʳᵈ can be a value other than approved/not_approved/etc to add to file"
