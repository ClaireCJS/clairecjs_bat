...
rem UNTIL 2025: sweep ( echos %ANSI_POSITION_SAVE%%@ANSI_MOVE[2,1]%ANSI_ERASE_CURRENT_LINE%%BIG_TOP%%EMOJI_BROOM%   %@ANSI_MOVE[3,1]%ANSI_ERASE_CURRENT_LINE%%BIG_BOT%%EMOJI_BROOM%   %ANSI_POSITION_RESTORE%%@RANDFG[] %+ if %@FILES[/s,%FILEMASK_AUDIO%] gt 0 (call        mp3index /s    >all.m3u) )
                sweep ( echos %ANSI_POSITION_SAVE%%@ANSI_MOVE[2,1]%ANSI_ERASE_CURRENT_LINE%%BIG_TOP%%EMOJI_BROOM%   %@ANSI_MOVE[3,1]%ANSI_ERASE_CURRENT_LINE%%BIG_BOT%%EMOJI_BROOM%   %ANSI_POSITION_RESTORE%%@RANDFG[] %+ if %@FILES[/s,%FILEMASK_AUDIO%] gt 0 (dir /b /s %filemask_audio% >all.m3u) )
rem AFTER 2025: ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
