...
1. Controlling *Winamp*: Music control, playlist management, and extracting the current song playing:
	...
	* [switch-winamp-to-playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files/switch-winamp-to-playlist.bat) aka [playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files/playlist.bat)  Replace existing Winamp plalylist
	* [enqueue-file-into-winamp-playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files/enqueue-file-into-winamp-playlist.bat.bat) — Enqueue single song to be the next playling song (had to recompile C code for this one)
	* [add-m3u-to-winamp-playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files/add-m3u-to-winamp-playlist.bat) — Append playlist to existing playlist
	* [enqueue-file-into-winamp-playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files/enqueue-file-into-winamp-playlist.bat.bat) — Append files from our collection that match a regular expression to the existing playlist. 
