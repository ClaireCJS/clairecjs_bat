...
The abridged instructions are: Install [TCC](http:///www.jpsoft.com), run *[clairevironment-install.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/clairevironment-install.bat)*, add [TCC](http:///www.jpsoft.com) to Windows Terminal, run it and change the command separator character, and you’re ready to run my environment!
...
1. Improving presentation with emoji 🎂 and unicode ⨝.  [set-emojis.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/set-emojis.bat) instantiates all the emoji listed in [emoji.env](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/emoji.env) [the good stuff is all at the *bottom* of that file].  Emoji are stored as ```EMOJI_{*EMOJINAME*}``` environment variables, and a few common ones like ```%STAR%``` and ```%ARROW%``` are defined at the bottom.  This is also where our ```%NEWLINE%``` and ```%TAB%``` variables get set.
...
1. Reduce mental fatigue be adding emoji to your scripts, particularly in the first column. It allows quicker understanding of what’s going on, often saving having to read. 
    1400+ emoji are defined as enironment variables in [set-emojis.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/set-emojis.bat), as well as custom pentacle & pentagram & trumpet emoji created by [ANSI escape codes](https://en.wikipedia.org/wiki/ANSI_escape_code) after hand-drawing and converting to [sixels](https://en.wikipedia.org/wiki/Sixel).
...
1. Copying music files:
	* [sync-playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/sync-playlist.bat) PLAYLIST.m3u e:\music-location\ - Copies all files in a playlist to a new location (probably a USB drive)
	* [update-each-folder-here-from-official-mp3-collection.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/update-each-folder-here-from-official-mp3-collection.bat) — Updates USB music files from same-named folders in official music repository
	* [sync-music.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/sync-music.bat) - generalized script that creates and relies on trigger files to automatically sync specific playlists to a specific USB drive
...
1. Tagging music: Displaying & embedding tags (including *album art* and *ReplayGain*) in audio files:
	...
	* Displaying *General*    Tags: [display-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/display-tags.bat) / [display-flac-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/display-flac-tags.bat) / [list-flac-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/list-flac-tags.bat) / [display-mp3-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/display-mp3-tags.bat) / [list-mp3-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/list-mp3-tags.bat) /  [list-all-mp3-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/list-all-mp3-tags.bat)
	* Displaying *ReplayGain* Tags: [list-replaygain-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/list-replaygain-tags.bat) / [list-flac-replaygain-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/list-flac-replaygain-tags.bat) / [list-mp3-replaygain-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/list-mp3-replaygain-tags.bat) / [list-replaygain-tags-in-all-flac-files.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/list-replaygain-tags-in-all-flac-files.bat)
	* Adding *ReplayGain* Tags: [add-ReplayGain-tags.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/add-ReplayGain-tags.bat) / [add-ReplayGain-tags-to-all-FLACs.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/add-ReplayGain-tags-to-all-FLACs.bat) / [add-ReplayGain-tags-to-all-mp3s.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/add-ReplayGain-tags-to-all-mp3s.bat)
	* Searching For *Album Art*: [album-art-tool-for-mp3Tag.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/album-art-tool-for-mp3Tag.bat)/[album-art-tool-for-mp3Tag-beforeDash.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/album-art-tool-for-mp3Tag-beforeDash.bat) — Used for searching for album art. Added as “tools” in our [Mp3Tag](https://www.mp3tag.de/en/) configuration.
...
1. Controlling *Winamp*: Music control, playlist management, and extracting the current song playing:
	...
	* [stop.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/winamp-stop.bat), [play.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/winamp-play.bat), [paus.btm](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/winamp-pause.bat) (without an e, as ```pause``` is a reserved command), [unpause.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/winamp-unpause.bat), [next.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/winamp-next.bat), [prev.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/winamp-prev.bat) — basic winamp stop/play/pause/unpase/next-track/previous-track functionality.
	* [winamp-randomize-playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/winamp-randomize-playlist.bat)
	aka [randomize.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/winamp-randomize-playlist.bat) — randomizes winamp’s playlist
	...
	* [enqueue-file-into-winamp-playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/enqueue-file-into-winamp-playlist.bat) — Enqueue single song to be the next playling song (had to recompile C code for this one)
	...
	* [enqueue-file-into-winamp-playlist.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/enqueue-file-into-winamp-playlist.bat) — Append files from our collection that match a regular expression to the existing playlist. 
	...
	* [create-srt-file-for-currently-playing-song.bat](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/create-srt-file-for-currently-playing-song.bat) – Uses the WhisperAI to [transcribe a SRT karaoke file for the currently playing song, so that lyrics can be read and highlighted as a song is played](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/docs/song-lyric-transcription-with-ai.md). Read more about it at [song-lyric-transcriptoi-with-ai.md](https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/docs/song-lyric-transcriptoi-with-ai.md).
...
1. Configure *[c:\tcmd\tcstart.bat(https://github.com/ClaireCJS/clairecjs_bat/blob/main/BAT-and-UTIL-files-1/tcstart.bat)*:    This is the minimal script that is run every time [TCC](http:///www.jpsoft.com) is opened, transient or not.<BR> 
...
1. You will also want to pay attention to *c:\bat\environm.btm*.<br>
	This is the script that is run every time [TCC](http:///www.jpsoft.com) is run in a non-transient way.<BR>
...
1. ENJOY THE CLARIEVIRONMENT!  There’s soooooooo much stuff in here. In the future, I will add more reference to this page about them. For the most part, you just have to explore. Most stuff is fairly heavily documented/commented.<BGR>
   ...
   Setpath.bat also generates a ```setpath.cmd``` so that if you go into ```CMD```, ```PowerShell```, or other shells, you can use that same generated path.
